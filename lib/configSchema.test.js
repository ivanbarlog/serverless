...
describe('#configSchema', () => {
  const cases = [
    ...
    {
      isValid: true,
      description: 'provider.resourcePolicy is an array of objects',
      mutation: {
        provider: {
          resourcePolicy: [
    ...
    {
      isValid: false,
      description: 'provider.resourcePolicy is an array',
    ...
    {
      isValid: false,
      description: 'provider.resourcePolicy is object',
      errorMessage: 'should be array',
      mutation: {
        provider: { resourcePolicy: { not: 'valid', at: 'all' } },
      },
    },
    {
      isValid: false,
      description: 'provider.resourcePolicy is an array but does not contains objects',
      errorMessage: 'should be object',
      mutation: {
        provider: { resourcePolicy: ['this', 'is', 'not', 'valid'] },
      },
    },
  ];
